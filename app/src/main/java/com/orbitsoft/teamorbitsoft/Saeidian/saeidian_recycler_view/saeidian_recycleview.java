...
public class saeidian_recycleview extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        saeidian_adapter adapter_saeidian = new saeidian_adapter(recycleview_arraylist);
...
//        saeidian_klid klids = new saeidian_klid();
        ...
        recycleview_arraylist.add(klid);
        ...
        recycleview_arraylist.add(klid6);
        ...
        recycleview_arraylist.add(klid7);
        ...
        recycleview_arraylist.add(klid8);
        ...
        recycleview_arraylist.add(klid9);
        ...
        recycleview_arraylist.add(klid10);
        ...
        recycleview_arraylist.add(klid11);
        ...
        recycleview_arraylist.add(klid12);
        ...
        recycleview_arraylist.add(klid13);
        ...
        recycleview_arraylist.add(klid14);
        ...
        recycleview_arraylist.add(klid15);
        ...
        recycleview_arraylist.add(klid16);
        ...
        recycleview_arraylist.add(klid17);
        ...
        recycleview_arraylist.add(klid18);
        ...
        recycleview_arraylist.add(klid19);
        ...
        recycleview_arraylist.add(klid20);
    }
