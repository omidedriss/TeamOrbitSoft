package com.orbitsoft.teamorbitsoft.Saeidian.saeidian_listview;
...
import com.orbitsoft.teamorbitsoft.Saeidian.saeidian_spinner.spinneradapter;
import com.orbitsoft.teamorbitsoft.Saeidian.test_cons;

import java.util.ArrayList;


public class saeidian_listview extends AppCompatActivity {

    ArrayList<saeidian_klid> saeidian_listview_array;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_saeidian_listview);
        initList();
        ListView listView = (ListView) findViewById(R.id.saeidian_listview);
        spinneradapter  adapter_listview = new spinneradapter(this, saeidian_listview_array);
    ...
    private void initList()
    {
        ...
        saeidian_listview_array =new ArrayList<>();
        ...
        saeidian_listview_array.add(klid);
        ...
        saeidian_listview_array.add(klid2);
        ...
        saeidian_listview_array.add(klid3);
        ...
        saeidian_listview_array.add(klid4);
        ...
        saeidian_listview_array.add(klid5);
        ...
        saeidian_listview_array.add(klid6);
        ...
        saeidian_listview_array.add(klid7);
        ...
        saeidian_listview_array.add(klid8);
        ...
        saeidian_listview_array.add(klid9);
        ...
        saeidian_listview_array.add(klid10);
        ...
        saeidian_listview_array.add(klid11);
        ...
        saeidian_listview_array.add(klid12);
        ...
        saeidian_listview_array.add(klid13);
        ...
        saeidian_listview_array.add(klid14);
        ...
        saeidian_listview_array.add(klid15);
        ...
        saeidian_listview_array.add(klid16);
        ...
        saeidian_listview_array.add(klid17);
        ...
        saeidian_listview_array.add(klid18);
        ...
        saeidian_listview_array.add(klid19);
        ...
        saeidian_listview_array.add(klid20);
    }
}
