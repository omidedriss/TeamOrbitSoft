...
public class Student_through_method {
    String name,family;
    double height,weight,lesson1,lesson2;
    int stunum;
    //متد مقداردهی داده ها
    void insertRecord(String name,String family,double height,double weight,
                      int stunum,double lesson1,double lesson2)
    {
        this.name=name;
        this.family=family;
        this.height=height;
    ...
    public double bmi(double weight, double height){
        //BMI=weight/height^2
        double v =weight / (Math.pow(height/100.0,2));
